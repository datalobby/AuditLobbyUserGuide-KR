...
### 1.6. Create template subfolder

1. Find the template folder to which you wish to add a template subfolder.
2. Click on it to view the action items to it.
...
7. This way, ‘n’ number of template subfolders can be created.
...
{% hint style="warning" %}
Duplicate template subfolders cannot be allowed while update.
{% endhint %}

### 2.2. Delete template subfolder
...
3. The deleted confirmation alert will be displayed.
4. Click the 'OK' button in the confirmation alert.
...
### 2.4. Sort template subfolders

> Using this, template subfolders can be sorted in ascending \(A-Z\)/ descending \(Z-A\) order.

1. By default the template subfolders will be displayed in the alphabetical order \(A-Z\).
2. Find the template folder in which you wish sort the subfolders.
