...
# \(Venu/Done\)8-1. Project Templates
...
6. You can view the created template subfolder under the template folder.
...
> Using this, you can add only one file \(Excel/ Word/ Pdf/ Audit Program\) at a time of type.
...
> Using this, you can add at most 10 files at a time with any extension.
...
{% hint style="info" %}
You can add at most 10 files and the max size of each file should be 30 MB only.
{% endhint %}
...
> **You can split the ‘Workpaper Name’ into two fields such as ‘Ref Num’ and ‘Workpaper Name’.**
>
...
> * You can view ‘1-1’ under the ‘Ref Num’ column and ‘This is Sample excel file’ under the ‘Workpaper Name’ column.

#### 3.5. Edit File

> Using this, reference number, name for existing files can be updated.

1. Find the file that you wish to revise the name or reference number.
2. Right-clicking it displays the following context menu options.
   * Assign to Role, Unassign from Role, Edit, Delete, Copy, Download
3. Clicking the 'Edit' option displays the 'Edit Template File' dialog.
4. Enter the revised reference number, description and click the 'Update' button.
5. You can view the success message at the top-right of the screen.

{% hint style="danger" %}
Files with the duplicate reference numbers cannot be updated within a template subfolder.
{% endhint %}

#### 3.6. Delete File

> Using this, existing files can be deleted.

1. Find the file that you wish to delete.
2. Right-clicking it displays the following context menu options.
   * Assign to Role, Unassign from Role, Edit, Delete, Copy, Download
3. Clicking the 'Delete' option displays the delete confirmation alert.
4. Click the 'OK' button in the confirmation alert.
5. You can view the delete success message and the file will be disappeared from the screen.

{% hint style="info" %}
Deleted file can be restored from the ‘Trash’ screen by super admin only.
{% endhint %}

#### 3.7. Assign to Role

> Using this, you can assign files to roles that are mandatory requires their Review.

* Find the file that you wish to assign the file to role\(s\).
* Right-clicking it displays the following context menu options.
  * Assign to Role, Unassign from Role, Edit, Delete, Copy, Download.
* Move the mouse focus to the 'Assign to Role' option.
* The following sub options will be displayed.
  * QC, CP, EP, P, D, M, SS, S.
* Click the intended role.
* The success message will be displayed at the top-right of the screen.
* The respective legend will be preceded to the Reference number.

> **Legend:**
>
> QC = Assigned To QC, CP = Assigned to CP, EP = Assigned to EP, P = Assigned to Partner, D = Assigned to Director, M = Assigned to Manager, SS = Assigned to Senior, S= Assigned to Staff.

{% hint style="info" %}
At a time only one role can be assigned to a file.

The respective role gets grayed out after assigning the role to a file.

At most, you can assign all roles to a file.
{% endhint %}

#### 3.8. Unassign from Role

> Using this, you can unassign files from roles.

* Find the file that you wish to unassign the file from role\(s\).
* Right-clicking it displays the following context menu options.
  * Assign to Role, Unassign from Role, Edit, Delete, Copy, Download.
* Move the mouse focus to the 'Unassign from Role' option.
* The following sub-options will be displayed. Among these, only assigned roles to file will be enabled and others will be grayed-out.
  * QC, CP, EP, P, D, M, SS, S.
* Click the intended role for the unassign.
* The success message will be displayed at the top-right of the screen.
* The respective legend will be removed to the Reference number.

#### 3.9. Download File

> Using this, you can download the file into your computer.

* Find the file that you wish to download.
* Right-clicking it displays the following context menu options.
  * Assign to Role, Unassign from Role, Edit, Delete, Copy, Download.
* Click the download option.
* Wait till the file gets downloaded into your computer.

{% hint style="info" %}
The file types Excel, Word, Pdf get downloaded into their original format.

Audit Program will be downloaded into an excel format.

The downloaded file name will be preceded with its respective reference number.
{% endhint %}
