...
> Using this, folders & files can be added to the template subfolder. This is the data that will be cloned into the Workpaper screen when a project is created using the Templates.
