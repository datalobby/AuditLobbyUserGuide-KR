...
> Using this, files can be added to the parent/ child folders. Files can be created in two ways.
>
> 1. New File
> 2. Multiple Files
...
9. You can view the success message and the created file under the folder.
